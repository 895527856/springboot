$(function() {
	...
	c.load("<div class='bef_comment writecode'>&nbsp;*hi,姓名：刘志萍，深圳组合有限公司的软件工程师</div>");
	c.load("<div class='bef_comment writecode'>&nbsp;*我的主要工作是软件开发</div>",2000);
	...
	w.load("<p><div class='writecode'>刘志萍</div>");
	w.load("<div class='writecode'>软件工程师(深圳组合科技有限公司)</div>");
	w.load("<div class='writecode'>软件开发工程师</div></p>");
	w.load("<h1 class='writecode'>联系我</h1>");
	w.load("<ul>");
	w.load("<li class='writecode'>mail:895527856@qq.com</li>");
	w.load("<li class='writecode'>tel:15727656028</li>");
	w.load("<li class='writecode'>github:<a href='https://github.com/895527856' target='_blank'>https://github.com/895527856</a></li>");
	w.load("</ul>");
	w.load("<h1 class='writecode'>技能</h1>");
	w.load("<ul>");
	w.load("<li class='writecode'>java：springboot,springcould,play,mybatis,springmvc,hibernate,struts,spring</li>");
	w.load("<li class='writecode'>DB：orcle,mysql,SQLServer,MongoDB,redis,solr,memcached</li>");
	w.load("<li class='writecode'>web：H5,CSS3,jQuery,bootStrap,easyUI,Ajax</li>");
	w.load("<li class='writecode'>System: win,liunx</li>");
	w.load("<li class='writecode'>project：药品管理系统，旅游系统，金融系统，城市系统)</li>");
	w.load("<li class='writecode'>server：tomcat,webService</li>");
	w.load("<li class='writecode'>tool：eclipse,idea,myEclipse,svn,git等</li>");
	w.load("<li class='writecode'>other：nginx,activeMQ,Dubbo,zookeeper,apache</li>");
	w.load("</ul>");
	w.load("<h1 class='writecode'>项目</h1>");
	w.load("<ul>");
	w.load("<li class='writecode'><a href='javascript:void(0);' target='_blank'>江西省药品管理系统</a></li>");
	w.load("<li class='writecode'><a href='javascript:void(0);' target='_blank'>健康城市</a></li>");
	w.load("<li class='writecode'><a href='javascript:void(0);' target='_blank'>小鹿网</a></li>");
	w.load("<li class='writecode'><a href='javascript:void(0);' target='_blank'>应收账款</a></li>");
	w.load("<li class='writecode'><a href='javascript:void(0);' target='_blank'>机动车旅游管理</a></li>");
	w.load("</ul>");
	w.load("<h1 class='writecode'>工作经历</h1>");
	w.load("<ul>");
	w.load("<li class='writecode'><a href='javascript:void(0);' target='_blank'>上海万达信息技术股份有限公司</a></li>");
	w.load("<li class='writecode'><a href='javascript:void(0);' target='_blank'>深圳英迈思文化科技有限公司</a></li>");
	w.load("<li class='writecode'><a href='javascript:void(0);' target='_blank'>深圳组合科技有限公司</a></li>");
	w.load("</ul>");
	c.load("<p><div class='comment writecode'>/**</div>");
	...
	c.load("<div class='comment writecode'>&nbsp;*QQ/微信:895527856</div>");
	c.load("<div class='comment writecode'>&nbsp;*mobile:15727656028</div>");
